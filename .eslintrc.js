module.exports = {
  ...
  rules: {
    ...
    '@typescript-eslint/no-unused-vars': 0, // if it's import var, tree-shaking will remove safely and ctrl+shift+O will auto delete unused import. And this rule is unnecessary for Debug
