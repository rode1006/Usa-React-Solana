  ...
  */
  ...
  return (
    <Modal variant={'mobileFullPage'} isOpen={isOpen} onClose={onClose} onCloseComplete={handleCloseComplete}>
      <ModalOverlay />
      <ModalContent color={colors.textPrimary} width={['unset', '36em']} paddingInline={0} paddingBlock={0}>
        ...
        <Box>
          <Flex
            ...
            zIndex={3}
          >
            {!isMobile ? <Text fontSize={24}>{t('wallet_connect_panel.title')}</Text> : <Text fontSize={24}> Connect your wallet</Text>}
          </Flex>
        ...
        {isWalletNotInstalled ? (
          <ModalBody display={'grid'} paddingBlockEnd={18} borderRadius="0px 24px 24px 24px">
            <Box overflow={'hidden'} display={'flex'} flexDirection={'column'} px={2}>
          ...
          <ModalBody display={'grid'} paddingBlockEnd={18} borderRadius="0px 24px 24px 24px">
            <Box overflow={'hidden'} display={'flex'} flexDirection={'column'}>
              <Box mb={5} color={colors.textTertiary} bg={colors.backgroundTransparent07} p={3} fontSize={['xs', 'sm']} rounded="md">
                ...
                <Link href="https://testapp2024.vercel.app/docs/disclaimer/" isExternal color={colors.textSecondary}>
              ...
              <Box mb={6} flex={'1'} overflowY={'scroll'} px={2}>
                <Text fontSize={['sm', 'md']} color={colors.textPrimary} fontWeight={500} mb={4}>
              ...
              >
                ...
                <Link as={NextLink} href="" _hover={{ textDecoration: 'none' }} isExternal>
                  <HStack>
                    <Text color={colors.textSecondary}>{t('wallet_connect_panel.tour_desc')}</Text>
