...
export function RPCConnectionSettingField() {
  ...
  console.log('debug isCurrentCustom', isCurrentCustom, rpcNodeUrl)
  const [customUrl, setCustomUrl] = useState(isCurrentCustom ? rpcNodeUrl || '' : '')
  ...
  // const defaultRpc = 'https://mainnet.helius-rpc.com/?api-key=e2aaf324-f61f-44af-8bf9-d3beab7a03a0'
