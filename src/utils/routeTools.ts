...
import { DashboardPageQuery } from '@/features/Dashboard'
import { ComingSoonPageQuery } from '@/features/ComingSoon'
...
export type PageRouteConfigs = {
  ...
  dashboard: {
    queryProps?: MayFunction<DashboardPageQuery, [{ currentPageQuery: ParsedUrlQuery }]>
  }
  comingsoon: {
    queryProps?: MayFunction<ComingSoonPageQuery, [{ currentPageQuery: ParsedUrlQuery }]>
  }
  swap: {
