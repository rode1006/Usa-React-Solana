        ...
        <GridItem area="panel">
          <Box>
            <Flex
              ...
              zIndex={3}
            >
              <Text whiteSpace={'pre-line'} w="fit-content" cursor="pointer" color={colors.textSecondary} fontWeight="500" fontSize={20}>
                {friendlySentence}
              </Text>
            </Flex>
            <div style={{ display: 'flex' }}>
          ...
          <Box w="full" h="24px" bg={colors.backgroundCardTap}></Box>
          <Flex flexDirection="column" gap={3} marginTop="-24px" borderRadius="0px 24px 24px 24px !important">
