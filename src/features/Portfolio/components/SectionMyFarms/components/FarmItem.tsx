...
import { Badge, Box, Flex, HStack, Text, useClipboard, Tag } from '@chakra-ui/react'
...
export default function FarmItem({
  ...
  return (
    <Box>
      ...
      <Flex {...panelCard} direction="column" marginTop="-24px" borderRadius="0px 24px 24px 24px" bg={colors.backgroundHead} border="none">
