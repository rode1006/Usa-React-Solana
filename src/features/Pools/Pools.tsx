...
export default function Pools() {
  ...
  const [currentLayoutStyle, setCurrentLayoutStyle] = useStateWithUrl('grid', 'layout', {
  ...
  return (
    <>
      <Flex flexDirection="column" height={'100%'} flexGrow={1} {...containerProps} marginTop="16px">
        {/* Title Part */}
        <Box {...titleContainerProps} display={['block', 'block']} flexShrink={0}>
          <Desktop>
        ...
        <Box marginX={revertAppLayoutPaddingX} mb={[0, 3]}>
          ...
          >
            ...
            <GridItem area={'btn'} justifySelf={'end'} display={'flex'} alignItems={'center'}>
