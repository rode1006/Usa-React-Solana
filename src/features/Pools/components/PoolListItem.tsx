...
export default function PoolListItem({
  ...
  console.log('debug styleType::', styleType)
  return (
    <>
      {styleType === 'list' ? (
              ...
              <Box>
                <Tooltip label={t('swap.title')}>
                  <Box
                    ...
                    onClick={onClickSwap}
                  >
                    <SwapPoolItemIcon fill={colors.textTitle} />
                  </Box>
                </Tooltip>
              </Box>
        ...
        <Box display="block" onClick={onPoolClick}>
          ...
          <Mobile>
            <Box>
              ...
              <Box w="full" h="24px" bg={colors.backgroundCardTap}></Box>
              <PanelCard overflow="hidden" bg={colors.backgroundLight} borderRadius="0px 24px 24px 24px" px={4} py={0} marginTop="-24px">
