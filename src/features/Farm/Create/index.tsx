...
export default function CreateFarm() {
  ...
  return (
    ...
    >
            ...
            description={
              <Text fontSize="sm" color={isMobile ? colors.textSecondary : colors.textTertiary}>
                <Trans i18nKey="create_farm.note_des">
                  ...
                  <Link
                    href="https://docs.imporium.io/raydium/pool-creation/creating-a-standard-amm-pool/creating-an-ecosystem-farm"
                    isExternal
                  >
                    Standard
                  </Link>
      ...
      <GridItem area="panel">
        {(currentStep === 'select' || currentStep === 'reward') && (
          <>
            <Box>
              <Flex
                className={swapStyles.top_header}
        ...
        <Box flexShrink={0} mr={currentStep === 'review' ? 4 : 0} marginTop="-24px">
          {currentStep === 'select' ? (
            <SelectPool
