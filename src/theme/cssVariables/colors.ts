export const darkColors: Record<keyof typeof colors, string> = {
  ...
  // component color
  backgroundDark: '#232734',
  backgroundDark50: '#23273480',
  backgroundCardTap: '#1d202c',
  backgroundChartTab: '#1d202c',
  backgroundCoinBox: '#404557',
  backgroundMedium: '#161E32',
  backgroundLight: '#272b3a',
  backgroundLight50: '#272b3a88',
  backgroundLight30: '#272b3a4d',
  ...
  // button
  buttonPrimary: '#822eda',
  buttonPrimary__01: '#822eda',
  ...
  // backgroundApp: '#13161e',
  backgroundApp: 'transparent',
  backgroundHead: '#272b3a',
  // solidButtonBg: 'linear-gradient(272.03deg, #39D0D8 2.63%, #822eda 95.31%)',
  solidButtonBg: '#07080b',
...
export const lightColors: Partial<typeof darkColors> = {
  ...
  // component color
  backgroundDark: '#f6f7fb',
  backgroundDark50: '#f6f7fb80',
  backgroundCardTap: '#878ea1',
  backgroundChartTab: '#822edb',
  backgroundCoinBox: '#fff',
  ...
  textTitle: '#822edb',
  textPrimary: '#878ea1',
  textSecondary: '#878ea1',
  textTertiary: '#878ea199',
  ...
  // customize (by V3 frontend coder)
  backgroundApp: '#f6f7fb',
  backgroundHead: '#ffffff',
  // solidButtonBg: 'linear-gradient(272deg, #4F53F3 2.63%, #8C6EEF 95.31%)',
  solidButtonBg: '#822edb',
...
export const colors = {
  ...
  backgroundCardTap: 'var(--background-cardtap)',
  backgroundChartTab: 'var(--background-charttab)',
  backgroundCoinBox: 'var(--background-coinbox)',
  ...
  textAllWhite: 'var(--text-allwhite)',
